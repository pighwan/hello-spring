...
//          에 따라 구현 클래스를 변경해야 하면 설정을 통해 스프링 빈으로 등록한다.
    private final JavaMemberService memberService;

    @Autowired
    public JavaMemberController(JavaMemberService memberService) {
    ...
    public String create(JavaMemberForm form) {
    ...
    public String list(Model model) {
        List<JavaMember> members = memberService.findMembers();
